...
<div class="h-screen bg-gray-100 dark:bg-gray-900 flex flex-col">
  ...
  <!-- Main content -->
  <div
    class="flex-1 flex flex-col md:flex-row overflow-hidden relative min-h-0"
  >
    ...
    >
      <div class="p-4">
        ...
        <button
          ...
          class="mt-4 w-full text-left px-3 py-2 rounded-md text-sm cursor-pointer font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 {selectedCategory ===
            'all' && !showingNotes
        ...
        <button
          ...
          class="mt-2 w-full text-left cursor-pointer px-3 py-2 rounded-md text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center {showingNotes
            ? 'bg-gray-100 dark:bg-gray-700'
            : ''}"
        >
          <svg
    ...
    <main class="flex-1 flex flex-col md:flex-row overflow-hidden">
      {#if !showingNotes}
        ...
        <div
          class="flex-1 bg-white dark:bg-gray-800 overflow-y-auto p-4 md:p-6"
        >
          {#if isAddingPassword}
